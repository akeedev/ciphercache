...
- `encode_message` serializes a dict to a 4-byte big-endian length prefix + UTF-8 JSON payload.
- `decode_single_frame` and `decode_frames` parse framed byte buffers back to dicts.
